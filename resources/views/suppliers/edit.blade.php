<x-app-layout>
    <div x-data="editSupplier({{ $supplier->id }})" x-init="init()">
        <!-- Breadcrumb -->
        <nav class="flex items-center text-sm text-gray-500 mb-6">
            ...
            <span class="text-gray-900 font-medium">Edit {{ $supplier->name }}</span>
        </nav>
        ...
        <div class="max-w-lg">
            <div class="card">
                <div class="card-header">
                    ...
                    <p class="text-sm text-gray-500 mt-0.5">Update supplier information.</p>
                </div>
                <div class="card-body">
                    <div class="mb-6">
            ...
            return {
                ...
                async submit() {
                    ...
                    try {
                        ...
                        else showToast(e.message || 'Failed to update supplier', 'error');
                    } finally {
